...
/* let cssQ = prompt('위치 이동을 위해 position:absolute를 사용했을 때 기준이 되는 태그에도 position:absolute를 써야한다.')
while(cssQ != 'x'){
    cssQ = prompt('위치 이동을 위해 position:absolute를 사용했을 때 기준이 되는 태그에도 position:absolute를 써야한다.')
}
alert('정답입니다! 이동할 위치 기준이 되는 태그에는 position:relative를 써야합니다.') */