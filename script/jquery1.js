//제이쿼리 시작
//자바스크립트 DOM제어를 쉽게 도와주는 라이브러리 언어
//제이쿼리 사용을 위해서는 cdnJs 설치파일을 링크로 연결해야 사용할 수 있다. (필수!)
...
//제이쿼리 변수와 자바스크립트 속성 및 메서드를 사용하고 싶다면 그 중간에 추가 속성을 붙여야한다.
...
$test.show() //display:block 호출함수명 em에게 이걸 주면 기본값인 inline으로 돌아간다.
$test.css({
    color:'blue',
    fontSize:'20px',
...
$p.eq(1).css('border','5px solid black') //몇번째 -> eq
